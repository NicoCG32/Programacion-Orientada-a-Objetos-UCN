...
Solución para Resiliencia de Programación Orientada a Objetos.
...
Solución/
├── main.java
└── [otras clases según corresponda]
```

## Cómo Cargar y Ejecutar en Eclipse

### Ubicación en el Repositorio
Este código se encuentra en: `Prog. Orientada a Objetos/PRUEBA 1/2023 S2 RESILIENCIA/Solución/src/`
...
1. **Obtener los archivos fuente:**
   ...
   - Navega a `Prog. Orientada a Objetos/PRUEBA 1/2023 S2 RESILIENCIA/Solución/`
   - Copia SOLO la carpeta `src/` a tu computadora

2. **En Eclipse, crear un nuevo proyecto Java:**
   - `File` → `New` → `Java Project`
   - Nombre: `Resiliencia_POO`
...
1. **Crear un nuevo proyecto Java en Eclipse:**
   - `File` → `New` → `Java Project` → Nombre: `Resiliencia_POO` → Finish

2. **Copiar los archivos `.java`:**
   - Abre el Explorador de archivos
   - Ve a `Prog. Orientada a Objetos/PRUEBA 1/2023 S2 RESILIENCIA/Solución/src/`
...
Consulta la documentación del curso para obtener una explicación detallada sobre los algoritmos y conceptos utilizados.