...
**Período**: 2025 Semestre 2  
**Tipo**: Recalificación

## Descripción

Solución para Recalificación de Programación Orientada a Objetos.
...
Este código se encuentra en: `Prog. Orientada a Objetos/RECA/2025 S2/Solución/src/`
...
1. **Obtener los archivos fuente:**
   ...
   - Navega a `Prog. Orientada a Objetos/RECA/2025 S2/Solución/`
...
1. **Crear un nuevo proyecto Java en Eclipse:**
   - `File` → `New` → `Java Project` → Nombre: `Reca_POO` → Finish

2. **Copiar los archivos `.java`:**
   - Abre el Explorador de archivos
   - Ve a `Prog. Orientada a Objetos/RECA/2025 S2/Solución/src/`
